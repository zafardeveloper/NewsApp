...
import com.example.newsapplication.view.categories.bottomSheet.CategoriesBottomSheet
import com.example.newsapplication.view.categories.tabFragment.TabFragment
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        listBtn.setOnClickListener {
            ...
            if (existingDialog == null) {
                val fragment = CategoriesBottomSheet(this)
